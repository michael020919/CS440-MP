...
class Alien:
    """The Meaty Alien that will be navigating our map
        ...
        Form 2 (Sausage):
            An oblong (sausage shape). This is represented as a line segment (it's spine) with a fixed length, and
            The diameter of the semicircle at each end of the sausage is equal to the *width* of the spine.
    """
