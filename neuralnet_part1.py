...
class NeuralNet(nn.Module):
    def __init__(self, lrate, loss_fn, in_size, out_size):
        ...
        self.f2 = nn.Linear(hidden_size, out_size)
    ...
    def forward(self, x):
        ...
        return self.f2(self.activation(self.f1(x)))
...
def fit(train_set,train_labels,dev_set,epochs,batch_size=100):
    ...
    net = NeuralNet(lrate = 0.03, loss_fn = loss_fn, in_size = in_size, out_size = out_size)
